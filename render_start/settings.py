"""
Django settings for render_start project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-%pww__oycj6o9*cky1^t$f0k3q2p#!61^92fm!v=#vl1*+@kbd')
...
ROOT_URLCONF = 'render_start.urls'
...
WSGI_APPLICATION = 'render_start.wsgi.application'
